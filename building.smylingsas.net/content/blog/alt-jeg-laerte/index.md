...
## SASS
Fixed! The issue was that Dart Sass (used by Hugo) doesn't support calc() expressions directly inside the min() function.

I've replaced it with clamp() instead, which is properly supported:
